...
static void FontFaceDescriptor_build(uType* type)
{
    ...
    ::TYPES[9] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(5/*SequenceEqual<string>*/, ::g::Uno::String_typeof(), NULL);
...
void ImageContainer::File(::g::Uno::UX::FileSource* value)
{
    ...
    if (((::g::Uno::Collections::ICollection::Count(uInterface(uPtr(files), ::TYPES[28/*Uno.Collections.ICollection<Uno.UX.FileSource>*/])) == 0) || (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(files), ::TYPES[28/*Uno.Collections.ICollection<Uno.UX.FileSource>*/])) > 1)) || ((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(files), ::TYPES[29/*Uno.Collections.IList<Uno.UX.FileSource>*/]), uCRef<int32_t>(0), &ret18), ret18) != value))
    {
