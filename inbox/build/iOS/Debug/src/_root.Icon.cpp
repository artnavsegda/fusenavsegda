...
{
    ::STRINGS[0] = uString::Const("Inbox.ux");
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Controls::Control_type, interface5),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Controls::Control_type, interface6),
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(::g::Fuse::Controls::Control_type, interface7),
        ...
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL), offsetof(::g::Fuse::Controls::Control_type, interface10),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(::g::Fuse::Controls::Control_type, interface11),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(::g::Fuse::Controls::Control_type, interface12),
...
::g::Fuse::Controls::Control_type* Icon_typeof()
{
    ...
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("Icon", options);
...
void Icon::InitializeUX()
{
    ...
    Margin(::g::Uno::Float4__New2(30.0f, 30.0f, 30.0f, 30.0f));
    SourceLineNumber(81);
    SourceFileName(::STRINGS[0/*"Inbox.ux"*/]);
}
