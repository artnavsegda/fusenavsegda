...
{
    DrawObjectWatcher::ShadingName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[33/*"Shading"*/]);
}
...
static void Stroke__cctor__fn(uType* __type)
{
    ...
    Stroke::_lineJoinMiterLimitName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[40/*"LineJoinMit...*/]);
}
...
static void Surface_build(uType* type)
{
    ...
    ::STRINGS[42] = uString::Const("/usr/local/share/uno/Packages/Fuse.Drawing.Surface/1.10.0-rc1/Surface.uno");
