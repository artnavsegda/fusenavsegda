...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.10.0-rc1/RaiseUserEvent.uno");
    ::STRINGS[2] = uString::Const("Perform");
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.10.0-rc1/NavigationActions.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
...
static void TimelineAction_build(uType* type)
{
    ...
    ::STRINGS[14] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/TimelineAction.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetInterfaces(
        ::g::Fuse::ISourceLocation_typeof(), offsetof(::g::Fuse::Triggers::Actions::TriggerAction_type, interface0));
    type->SetFields(10,
...
static void Toggle_build(uType* type)
{
    ...
    ::STRINGS[16] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/Toggle.uno");
    ::STRINGS[2] = uString::Const("Perform");
...
static void TransitionLayout_build(uType* type)
{
    ...
    ::STRINGS[18] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.10.0-rc1/Triggers/LayoutAnimation.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[0] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[25] = ::g::Uno::Action_typeof();
...
static void TransitionState_build(uType* type)
{
    ...
    ::STRINGS[20] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.10.0-rc1/Actions/StateTransition.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetInterfaces(
        ::g::Fuse::ISourceLocation_typeof(), offsetof(::g::Fuse::Triggers::Actions::TriggerAction_type, interface0));
    type->SetFields(10,
