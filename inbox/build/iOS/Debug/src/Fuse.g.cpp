...
bool Marshal::TryConvertTo(uType* t, uObject* o, uObject** res, uObject* diagnosticSource)
{
    ...
    if (diagnosticSource != NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[42/*"Cannot conv...*/], o), uString::Const("' to target type '")), t), ::STRINGS[44/*"'"*/]), diagnosticSource, uString::Const("/usr/local/share/uno/Packages/Fuse.Marshal/1.10.0-rc1/Marshal.Convert.uno"), 103, uString::Const("TryConvertTo"), NULL);
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[55] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.10.0-rc1/UserEvent.uno");
    ...
    ::STRINGS[58] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.10.0-rc1/UserEvent.ScriptClass.uno");
...
void UserEventArgs__FuseScriptingIScriptEventSerialize_fn(UserEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[48/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[62/*"name"*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->Dispatch())->Name()));
...
static void VisualEvent_build(uType* type)
{
    ...
    ::STRINGS[64] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.10.0-rc1/Event.uno");
